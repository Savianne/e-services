...
const DeleteModal: React.FC<{onDeleteSuccess: () => void}> = ({onDeleteSuccess}) => {
    ...
    React.useEffect(() => {
        setComponentTheme({
            ...
            mainBackground: theme.palette.mode == "dark"? "#1a2035" : "#F9F9F9",
            lightBackground: theme.palette.mode == "dark"? "#3e8cba2e" : "#e6f2fa",
            textColor: theme.palette.mode == "dark"? "#fff" : "#000000",
        })
    }, [theme.palette.mode])
    return <DeleteModalStyled theme={componentTheme} onDeleteSuccess={() => onDeleteSuccess()}/>
}
